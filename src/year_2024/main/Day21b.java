...
public class Day21b {
    ...
    private final List<String> toType = Helper.readToStringArrayList(2024, 21);
...
//        return Long.toString(solve(25));
    ...
    private long countPushes(String robot1Move, int depth) {
        ...
        System.out.println(robot1Move + " " + depth + " " + sum);
        return sum;
    }
    ...
    public static void main(String[] args) {
        String input = Helper.readToString(2024, 21);
        Day21b day = new Day21b();
